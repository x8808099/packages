/****************************************************************************
** Meta object code from reading C++ file 'p_run_metrics_script.h'
**
...
#error "The header file 'p_run_metrics_script.h' doesn't include <QObject>."
...
const QMetaObject JSConsole::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_JSConsole.data,
      qt_meta_data_JSConsole,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *JSConsole::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_JSConsole.stringdata0))
        return static_cast<void*>(const_cast< JSConsole*>(this));
